...
The current scientific-core implementation plan and qualification boundaries are in
[`SCIENTIFIC_CORE_ROADMAP.md`](https://github.com/yongjunx23-del/SDPX.jl/blob/main/docs/design/SCIENTIFIC_CORE_ROADMAP.md).
