...
## Starts and continuation

The public product-HSD route is currently cold-start only. `warm_start` and
explicit primal/dual model starts fail before numerical setup rather than
