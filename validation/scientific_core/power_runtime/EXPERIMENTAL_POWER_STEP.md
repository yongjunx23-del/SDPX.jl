...
Cold start -> certified terminal in 28 accepted steps. Every step is a genuine
...
lineage, epoch). Homotopy/merit/progress gates replicated unchanged from
src/hsd. Terminal original-coordinate audit (independent of the loop code):
- merit (homogeneous residuals) 8.65e-9 <= 1e-8 target
- recovered primal residual 1.24e-9, dual residual 4.90e-10
- complementarity s'y/tau^2 = 4.68e-9 ; cone membership true (1e-7 band)
- objective 1.1242390974964616 vs exact 1.1242390986454483421 -> err 1.15e-9

143 driver assertions pass at the frozen worktree HEAD; per-step next-epoch
five-equation certification (2^-17) and NC affine certification are asserted.
