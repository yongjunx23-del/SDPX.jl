...
function snapshot()
    ...
    for f in ("power_half_phi_reference.jl","power_half_root_geometry.jl","power_half_root_geometry_capture.jl",
        ...
        "native_factor_affine_certificate.jl","factor_combined_epoch.jl","FACTOR_COMBINED_EPOCH.md",
        "test_factor_combined_epoch.jl","run_factor_combined_epoch.jl",
        "half_power_polynomial_root.jl","native_half_pair.jl","NATIVE_HALF_PAIR.md",
        "test_native_half_pair.jl","run_native_half_pair.jl",
