#=====================================================================
    Legacy SDP interior-point engine. Main loop (§1.6 merges
    cold-start/warm-start/findFeasible into one `solve!`), termination
    (§5.1), restart repair (§5.2). Checkpoint I/O (§5.5) lives in
    `src/checkpoint.jl`; generic option/identity/precision helpers live
    in `src/pipeline/*` and `src/certificates/certificates.jl`.
=====================================================================#
