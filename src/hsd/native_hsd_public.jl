...
function _native_hsd_plan(
    ...
    planned_route = settings.kkt_route
    ...
    parameters = (
        ...
        executed_threads=min(max(Int(settings.limits.threads), 1),
...
# The certification module owns all original-coordinate certificate builders.
@inline _native_hsd_certificate_limits(args...) = SDPXCertification._native_hsd_certificate_limits(args...)
@inline _native_hsd_primal_infeasible_certificate(args...) = SDPXCertification._native_hsd_primal_infeasible_certificate(args...)
@inline _native_hsd_dual_infeasible_certificate(args...) = SDPXCertification._native_hsd_dual_infeasible_certificate(args...)
@inline _native_hsd_unavailable_certificate(args...) = SDPXCertification._native_hsd_unavailable_certificate(args...)
